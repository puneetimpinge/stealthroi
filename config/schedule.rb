...
every :hour do
  ...
  command 'cd /home/ritika/RubymineProjects/Puneet/stealth_app && bundle install && bin/rake get_keywords'
  command 'cd /home/ritika/RubymineProjects/Puneet/stealth_app && bundle install && bin/rake shopify_stats'
end
